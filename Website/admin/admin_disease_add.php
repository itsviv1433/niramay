...
if(isset($_POST['submit'])) {
    ...
    $update_sql = "INSERT INTO `disease`(`disease_name`, `disease_symptoms`, `modes_of_transmission`, `disease_detail`, `disease_precaution`, `test_name`, `test_price`, `test_details`, `vaccine_name`, `vaccine_price`) VALUES ('$disease_name','$disease_symptoms','$disease_mot','$disease_detail','$disease_precaution','$test_name','$test_price','$test_details','$vaccine_name','$vaccine_price')";
            ...
            <div class="content pb-0">
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header"><strong>Add Disease</strong><small> </small></div>
                                    ...
                                    <div class="card-body card-block">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="number" name="test_price" placeholder="Enter Test Price" class="form-control" required rows="1"><?php echo $disease_price ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="mobile" class=" form-control-label">Test Details</label>
                                            <textarea type="text" name="test_details" placeholder="Enter Details" class="form-control" required rows="4"><?php echo $test_detail ?></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="number" name="vaccine_price" placeholder="Enter Vaccine Price" class="form-control" required rows="1"><?php echo $vaccine_price ?></textarea>
                                        </div>
