...
if(isset($_POST['submit'])) {
    ...
    $validateuserres = mysqli_query($conn,$validateusernamequery);
    if(mysqli_num_rows($validateuserres) > 0) { 
        $msg = "Username Already Taken.Please Take Another One";
    }else{
        if (strlen($phone) == 10) {
            if (strlen($password) > 6) {
                if ($password == $rpassword) {
                    $update_sql = "INSERT INTO `user`(`name`, `username`, `email`, `phone`,`password`,`isadmin`) VALUES ('$name','$username','$email','$phone','$password','$isadmin')";
            ...
            <div class="content pb-0">
                <div class="animated fadeIn">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header"><strong>Add Profile User</strong><small> </small></div>
                                <form method="POST" enctype="multipart/form-data" action="">
                                    <div class="card-body card-block">
                                        ...
                                        <label for="password" class=" form-control-label">Profile Type</label><br>
