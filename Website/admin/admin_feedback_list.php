...
if(isset($_SESSION['admin']) && isset($_SESSION['isauth'])){
    ...
    if(isset($_GET['type']) && $_GET['type']!=''){
    	...
    	if($type=='delete'){
    	    $id=$_GET['id'];
            $delete_sql="delete from contactform where id='$id'";
            mysqli_query($conn,$delete_sql);
    	}
    }
    $sql="select * from contactform order by id asc";
                      ...
                      <div class="" style="display:flex;">
                        ...
                        <div class="container">
            		        <div class="col-12 col-md-12 col-sm-12 py-1" style="display:inline-block;">
                                <button type="button" 
                                   onclick="window.location.replace('./admin_feedback_list.php?logout=1');"
                ...
                <div class="col-12" style="padding:15px;">
        			<div class="collapse" id="navbarToggleExternalContent">
                      <div class="bg-dark p-2">
                        <a href="./admin_home.php"><p class="text-light text-left mt-2" style="font-size:25px;width:100%;">Hello Dear <?php echo $admindata->username; ?></p></a>
                      </div>
                    </div>
                </div>
			</header> <!-- .site-header -->
