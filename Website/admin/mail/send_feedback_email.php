<?php
    ...
    $mail->setFrom('healthcare.niramay@gmail.com', $name); // From email and name
    $mail->addAddress('niramayhealthcarefeedback@gmail.com','Niramay HealthCare Team'); // to email and name
