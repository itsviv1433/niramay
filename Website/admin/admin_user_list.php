...
if(isset($_SESSION['admin']) && isset($_SESSION['isauth'])){
    ...
    if(isset($_GET['type']) && $_GET['type']!=''){
    	...
    	if($type=='status'){
    		...
    		$update_status_sql="update user set status='$status' where user_id='$id'";
                      ...
                      <div class="" style="display:flex;">
                        ...
                        <div class="container">
            		        <div class="col-12 col-md-12 col-sm-12 py-1" style="display:inline-block;">
                                <button type="button" 
                                   onclick="window.location.replace('./admin_user_list.php?logout=1');"
                                    style="float:right;" class="btn btn-outline-light">Logout
                                </button>
                                <button type="button" 
                                   onclick="window.location.replace('./admin_user_add.php');"
                                    style="float:right;" class="btn btn-outline-light">Add User
                                </button>
                        	</div>
            	        </div>
                      </div>
            						 ...
            						 <tbody>
            							...
            							<tr>
            							   ...
            							   <td style="display: flex; flex-flow:column;">
            								...
            								echo "<span class='badge badge-edit'><a href='admin_user_edit.php?id=".$row['user_id']."'>Edit</a></span>&nbsp;";
